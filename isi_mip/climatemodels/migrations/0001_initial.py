    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='climatemodels.ClimateDataType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calibration_catchments', models.TextField(blank=True, help_text='How many catchments was the calibration carried out?', null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='climatemodels.InputData'),
        ),
        migrations.AddField(
            model_name='general',
